...
// var wol = ["Jan", "Fab", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
// alert(wol[month]);
// alert(month + 1);
...
// now에서 2022-02-03이라는 이 시간을 빼면 => 지나온 세월 
...
$(document).ready(function(){
    ...
    // .main에 마우스 올렸을때 이런일이 벌어질것이다.
        // 방금그것의 자식중 .sub라고 하는 녀석을 보여주자.
